...
namespace CustomVision
{
    ...
    public class ObjectDetection
    {
        ...
        private ExtractBoxResult ExtractBoxes(TensorFloat predictionOutput, float[] anchors)
        {
            ...
            return new ExtractBoxResult() { Boxes = boxes, Probs = probs };
        }
        ...
        {
            var result = this.ExtractBoxes(predictionOutputs, ObjectDetection.Anchors);
            return this.SuppressNonMaximum(result.Boxes, result.Probs);
        }
#endif

    }

    public class ExtractBoxResult
    {
        public IList<BoundingBox> Boxes;
        public IList<float[]> Probs;
    }
}
